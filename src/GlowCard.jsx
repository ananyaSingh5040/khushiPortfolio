...
export const GlowCard = ({ title, description, glowColor, children, width, height }) => {
  const [randomGlow, setRandomGlow] = useState(glowColor);

  const handleHover = () => {
    setRandomGlow(getRandomColor());
  };
  ...
  return (
    <div
      ...
      onMouseLeave={() => setRandomGlow(glowColor)}
    >
